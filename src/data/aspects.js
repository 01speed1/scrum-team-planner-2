export default {
  ...
  configuration: [
    {
      aspect: "Requiere cambios en la configuración de la aplicación",
      points: 2
    }
  ],
  javascript: [
  ...
  testing: [
    { aspect: "Requiere implementar pruebas", points: 2 },
    { aspect: "Requiere modificar pruebas existentes", points: 2 }
  ]
};
